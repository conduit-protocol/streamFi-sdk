...
class StreamsModule {
    ...
    async subscribeAsync(streamId, handlers) {
        ...
        const { subscribeToStream } = await Promise.resolve().then(function () { return require('./events-DBZs8BKk.js'); });
...
function parseGovernorConfig(val) {
    ...
    return {
        ...
        factoryAddress: m['factory_address'] ? stellarSdk.Address.fromScVal(m['factory_address']).toString() : '',
    };
}
...
//# sourceMappingURL=index-CYWDEMJZ.js.map
