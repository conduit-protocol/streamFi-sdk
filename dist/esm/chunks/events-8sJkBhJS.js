...
import { s as scValToI128, a as scValToU64 } from './index-BxhGdsQ2.js';
import '../utils.js';
...
function i128Field(fields, index) {
    const field = fields[index];
    return field ? scValToI128(field) : 0n;
}
function u64Field(fields, index) {
    const field = fields[index];
...
export { dispatchEvent, subscribeToStream };
//# sourceMappingURL=events-8sJkBhJS.js.map
